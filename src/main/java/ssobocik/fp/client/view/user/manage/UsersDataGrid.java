...
/**
 * Data grid with usernames and nicknames,
 * serves as a selector for editor
 * @author szymon.sobocik
 */
public class UsersDataGrid extends DataGrid<UserDTO> {

    static final Logger logger = Logger.getLogger(UsersDataGrid.class.getName());
